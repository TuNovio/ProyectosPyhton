...
try:
    ...
    with conexion:
        with conexion.cursor() as cursor:
            #se crea una cadena para eliminar los valores de una tabla dado el identificador
            sentencia='delete from persona where identificacion=%s'
            #se ejecuta la sentencias
            cursor.execute(sentencia, (12,),)
